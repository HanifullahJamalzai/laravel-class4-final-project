            ...
            <div class="swiper-wrapper">
              ...
              @foreach ($sliders as $slider)
                <div class="swiper-slide">
                  <a href="single-post.html" class="img-bg d-flex align-items-end" style="background-image: url('{{ $slider->photo }}');">
        ...
        <div class="col-lg-4">
          <div class="post-entry-1 lg">
            ...
            <div class="d-flex align-items-center author">
              ...
              <div class="name">
                {{-- <h3 class="m-0 p-0">{{ $catFirst[0]->user->name }}</h3> --}}
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-8">
          <div class="row g-5">
            <div class="col-lg-4 border-start custom-border">
              ...
              <div class="post-entry-1">
                <a href="single-post.html"><img src="{{ $catFirst[2]->photo }}" alt="" class="img-fluid"></a>
                <div class="post-meta"><span class="date">Food</span> <span class="mx-1">&bullet;</span> <span>Jul 17th '22</span></div>
                <h2><a href="single-post.html">How to Avoid Distraction and Stay Focused During Video Calls?</a></h2>
              </div>
              <div class="post-entry-1">
                <a href="single-post.html"><img src="{{ $catFirst[3]->photo }}" alt="" class="img-fluid"></a>
            ...
            <div class="col-lg-4 border-start custom-border">
              ...
              <div class="post-entry-1">
                <a href="single-post.html"><img src="{{ $catFirst[5]->photo }}" alt="" class="img-fluid"></a>
                <div class="post-meta"><span class="date">Tech</span> <span class="mx-1">&bullet;</span> <span>Mar 1st '22</span></div>
                <h2><a href="single-post.html">10 Life-Changing Hacks Every Working Mom Should Know</a></h2>
              </div>
              <div class="post-entry-1">
                <a href="single-post.html"><img src="{{ $catFirst[6]->photo }}" alt="" class="img-fluid"></a>
